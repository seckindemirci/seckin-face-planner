...
st.title("Seçkin Face Planner")
st.write("Fotoğraf üzerinden yüz analizi yapın ve PDF raporu oluşturun.")

uploaded_file = st.file_uploader("Bir yüz fotoğrafı yükleyin", type=["jpg", "jpeg", "png"])
patient_name = st.text_input("Hasta Adı ve Soyadı")
...
if uploaded_file and patient_name:
    ...
    st.info("Lütfen bir fotoğraf yükleyin ve hasta adını girin.")
